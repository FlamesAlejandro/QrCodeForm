            ...
            <Container component="main">
                ...
                <form onSubmit={generarQrCode} sx={{ mt: 3, width: '100%', }}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth type="text" placeholder="EmpresaCamion" value={nombreChofer}  />
                        </Grid>
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth type="text" placeholder="RutEmpresaCamion" value={nombreChofer}  />
                        </Grid>
                        <Grid item xs={12} sm={6}>
