...
export const Form = () => {
    ...
    const  handleChofer = ( { target }) => {
        ...
        console.log('este es el name'+name, 'este es el valuevalue);
            ...
            <Container component="main">
                ...
                <form onSubmit={generarQrCode} sx={{ mt: 3, width: '100%', }}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth type="text" placeholder="RutChofer" value={formulario.rutChofer} onChange={handleChofer} />
                        </Grid>
                        <Grid item xs={12} sm={6}>
