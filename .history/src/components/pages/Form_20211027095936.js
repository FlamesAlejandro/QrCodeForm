                ...
                <form onSubmit={generarQrCode} sx={{ mt: 3, width: '100%', }}>
                    <Grid container spacing={2}>
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth type="text" placeholder="NombreChofer" value={formulario.nombreChofer}  />
                        </Grid>
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth type="text" placeholder="RutChofer" onChange={handleChange} name="RutChofer" value={formulario.rutChofer} onBlur={handleChofer} />
                        </Grid>
                        <Grid item xs={12} sm={6}>
