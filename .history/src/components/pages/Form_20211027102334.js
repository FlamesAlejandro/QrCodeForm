...
export const Form = () => {
    ...
    const  handleChofer = ( { target }) => {
        ...
        console.log(formulario);
            ...
            setFormulario({
                ...formulario,
                rutChofer: JSON.stringify(newdata.rut),
                nombreChofer: JSON.stringifynewdata.nombre,
                correoChofer: JSON.stringifynewdata.correo,
                telefonoChofer: JSON.stringifynewdata.telefono,
            });
            console.log(newdata);
            console.log(formulario);
