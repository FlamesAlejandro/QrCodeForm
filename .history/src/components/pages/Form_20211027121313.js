...
import { empresaCamion } from '../data/empresaCamion';
            ...
            <Container component="main">
                ...
                <form onSubmit={onSubmit} sx={{ mt: 3, width: '100%', }}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth type="text" placeholder="rutChofer" value={rutChofer} onChange={handleChange} name="rutChofer" onBlur={handleChofer} />
                        </Grid>
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth type="text" placeholder="EmpresaCamion" name={empresaCamion} value={empresaCamion} onChange={handleChange}  />
                        </Grid>
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth type="text" placeholder="RutEmpresaCamion" name={rutEmpresa} value={rutEmpresa} onChange={handleChange}  />
                        </Grid>
                        <Grid item xs={12} sm={6}>
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth type="text" placeholder="CorreoChofer" value={formulario.correoChofer} onChange={handleChange} />
                        </Grid>
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth type="text" placeholder="TipoTraslado"  />
                        </Grid>
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth type="text" placeholder="Telefono" value={formulario.telefonoChofer} onChange={handleChange}  />
                        </Grid>
                        <Grid item xs={12} sm={6}>
