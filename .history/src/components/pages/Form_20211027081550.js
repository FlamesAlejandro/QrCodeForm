                ...
                <form onSubmit={handleSubmit(onSubmit)} sx={{ mt: 3, width: '100%', }}>
                    <Grid container spacing={2}>
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth type="text" placeholder="NombreChofer" {...register("NombreChofer", {})} />
                        </Grid>
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth type="text" placeholder="RutChofer" onChange={handleChofer} {...register("RutChofer", {})} />
                        </Grid>
                        <Grid item xs={12} sm={6}>
