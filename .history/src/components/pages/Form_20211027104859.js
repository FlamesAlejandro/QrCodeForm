...
export const Form = () => {
    ...
    const  handleChofer = ( { target }) => {
        ...
        if (camioneros.filter( chofer => chofer.rut === value))        const newdata = camioneros.filter( chofer => chofer.rut === value);
                ...
                <form onSubmit={generarQrCode} sx={{ mt: 3, width: '100%', }}>
                    <Grid container spacing={2}>
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth type="text" placeholder="nombreChofer" value={nombreChofer} onChange={handleChange}  />
                        </Grid>
                        <Grid item xs={12} sm={6}>
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth type="text" placeholder="CorreoChofer" value={correoChofer} onChange={handleChange} />
                        </Grid>
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth type="text" placeholder="TipoTraslado"  />
                        </Grid>
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth type="text" placeholder="Telefono" value={telefonoChofer} onChange={handleChange}  />
                        </Grid>
                        <Grid item xs={12} sm={6}>
